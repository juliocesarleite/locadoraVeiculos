...
import locadoraveiculos.infra.ClienteDAO;
...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Numero da casa:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       v = vdao.recuperarPorID(Integer.parseInt(jTextField7.getText()));
       
       jTextField8.setText(v.getModeloVeiculo());
       //jTextField9.setText((v.getAnoVeiculo()));
       jTextField12.setText(v.getCorVeiculo());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        end.setRua(jTextField5.getText());
        end.setNumero(Integer.parseInt(jTextField6.getText()));
        
        VeiculoDAO vdao = new VeiculoDAO();
        
        Veiculo v = vdao.recuperarPorID(Integer.parseInt(jTextField7.getText()));
        
        List<Veiculo> vcliente = new ArrayList();
        
        vcliente.add(v);
        
        Cliente c = new Cliente();
        c.setNomeCliente(jTextField2.getText());
        c.setEmailCliente(jTextField3.getText());
        c.setRGCliente(Integer.parseInt(jTextField4.getText()));
        c.setEndereco(end);
        c.setVeiculos(vcliente);
